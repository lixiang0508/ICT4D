...
public interface ProductMapper {
    ...
    void addProduct(@Param("productId")Integer productId,@Param("userId") Integer userId, @Param("categoryId") Integer category_id, @Param("userName") String userName, @Param("name") String name,
                    @Param("quantity") Integer quantity, @Param("price") Double price, @Param("address") String address,@Param("information") String information,@Param("contact") String contact);
